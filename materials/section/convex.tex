...
\begin{enumerate}[(a)]
    \item Have a unique global minimizer $\xx^\star$.
    \item Generally have efficient algorithms for finding that minimizer.
\end{enumerate}
...
\begin{align*}
    \text{minimize: } & f_0(x)\\
    \text{subj. to: } & f_i(x) \leq 0, \quad i=1,\dots,m\\
...
$h_i : \RR^n \mapsto \RR$ is an \textbf{equality constraint}.
